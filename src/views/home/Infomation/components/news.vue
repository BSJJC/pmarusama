<template>
  ...
  >
    <!-- news publish date -->
    <div
      class="fredoka-one flex justify-center items-center w-[30%] text-[#f60] font-bold md:w-[15%]"
    >
      <div
        class="flex justify-center items-center flex-col text-[0.5rem] pr-2 md:text-[0.8rem]"
      >
    ...
    <!-- news title -->
    <div
      class="m-plus-rounded-1c w-[70%] border-l-[1px] border-r-[1px] border-[#f60] px-3 md:w-[85%]"
    >
...
const data = [
  {
    data: "2022/12/16",
    title:
      "TVアニメ「お兄ちゃんはおしまい！」OPテーマにえなこ feat.P丸様。として参加決定！",
  },
  {
    data: "2022/11/01",
    title:
      "[セガプライズ]11月発売「P丸様。 寝そべり モアプラスぬいぐるみ“P丸様。＆うさぎさん＆くまくん“」",
  },
  {
    data: "2022/10/08",
    title:
      "2ndフルアルバム『ラブホリック』より新曲「恋愛偏差値上昇中！」MV公開!",
  },
];
