<template>
  <div ref="discographyRef" class="grid grid-cols-2 w-full mt-4 md:grid-cols-3 lg:max-w-[1060px] lg:mx-auto">
...
onMounted(() => {
  ...
  overrallEnterAnimation(discographyRef.value!, ['DIV'], discographyAnimationConfig, 300, 100);
});
</script>
