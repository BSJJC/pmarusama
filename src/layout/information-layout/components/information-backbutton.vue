<template>
  <Transition>
    <div>
      ...
      <svg
        @click="goBack"
        class="w-[50px] top-8 left-[5vw] transition-transform ease-in-out z-[999] hover:cursor-pointer hover:translate-x-[-10px] active:translate-x-0"
...
const buttonTop: Ref<number> = ref(50);
